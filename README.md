...
The current checkpoint is a dependency-free, in-memory vertical slice. It supports job submission, idempotent requests, job lookup, leased claiming, and lease-validated completion. PostgreSQL durability is the next milestone.
